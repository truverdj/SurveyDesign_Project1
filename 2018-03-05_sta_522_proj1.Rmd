...
The basic test for whether or not a course made the frame was whether its course name included "biology," "chemistry," "computer science," "evolutionary antrhopoly," "mathematics," "physics," "psychology," "neuroscience," or "statistical science." For example, we did not include "info science", but did include "biology" and "neurobiology," even though it is not listed explicitly by those names on the natural science website. Some course names, such as "biostatistics," have no courses numbered below 700; we excluded them.
